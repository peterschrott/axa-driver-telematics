...
The main application of the deep learning auto-encoder is dimensionality reduction. In our case, though, we want to use the deep learning auto-encoder in order to perform unsupervised anomaly detection. \\
...
%TODO Write some more stuff about H2O/Sparkling Water
