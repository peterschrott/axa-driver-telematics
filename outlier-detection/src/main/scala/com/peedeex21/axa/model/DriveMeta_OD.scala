...
class DriveMeta_OD extends Product with Serializable {
  ...
  def this(driverId: Int, driveId: Int, duration: Double, distance: Double, speedMax: Double,
           speedMedian: Double, speedMean: Double, speedMeanDeviation: Double, speedSd: Double,
           speedMeanDriver: Double, speedSdDriver: Double, accMax: Double, accMedian: Double,
           accMean: Double, accMeanDeviation: Double, accSd: Double, accMeanDriver: Double,
           accSdDriver: Double, angleMedian: Double, angleMean: Double, turns35P: Double,
           turns35N: Double, turns70P: Double, turns70N: Double, turns160P: Double,
           turns160N: Double, turnsBiggerMean: Double, turnsU: Double, stopDriveRatio: Double,
           stops1Sec: Double, stops3Sec: Double, stops10Sec: Double, stops120Sec: Double) {
    this()
